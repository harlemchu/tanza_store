...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _confirmExit() async {
    ...
    if (shouldExit == true) {
      // On Android, this will close the app; on iOS, it may not.
      // For a better cross‑platform experience, you can use SystemNavigator.pop()
      // but that only works on Android.
      // For now, we'll just close the app using a platform method.
      // You can import 'package:flutter/services.dart' and use SystemNavigator.pop().
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // No explicit leading – Scaffold's drawer automatically adds the hamburger icon
        ...
        actions: const [], // Keep empty for now
      ),
      drawer: Drawer(
        child: ListView(
