...
//   // --------------------------------------------------------------------
//   // NEW: Push local products to Firebase
//   // --------------------------------------------------------------------
...
//     try {
//       await syncService.pushLocalDataToFirestore();
//       // final uploaded = await syncService.pushLocalProductsToFirestore(
//       //   onProgress: (total, completed) {
//       //     // you can update the dialog text here if you wish
//       //   },
//       // );
...
//   // --------------------------------------------------------------------
//   // Existing sync method (if you already had one)
//   // --------------------------------------------------------------------
...
//     try {
//       final updated = await syncService.syncPrices();
//       if (mounted) Navigator.pop(context);
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('Sync complete! $updated product prices updated.'),
//           backgroundColor: Colors.green,
//         ),
//       );
